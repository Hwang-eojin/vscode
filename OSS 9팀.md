...
- VSCode에서 스니핏(Snippets)은 자주 사용하는 소스 코드를 미리 정의하여 지정해 둔 예약어로 한 번에 불러올 수 있는 기능을 말한다. 즉, 소스 코드 자동 완성이다. 
...
- 코드 조각은 VS Code에서 자체적으로 제공하는 내장 코드 조각과, 사용자가 직접 정의한 사용자 정의 코드 조각으로 구분할 수 있다.
 ...
 ![자동완성 코드](https://github.com/Hwang-eojin/vscode/assets/166198931/3007ee54-02f7-41ba-96c7-30203b4db706)
