...
3. IDE 기능
   ...
   - Visual Studio Code(VSCode)는 기본적으로 강력한 코드 에디터이지만 다양한 확장 프로그램을 통해 거의  모든 주요 프로그래밍 언어에 대한 통합 개발 환경(IDE)처럼 기능을 확장할 수 있다.
   ...
   - IDE 사용 예시
     ...
     - | ![img](https://github.com/Hwang-eojin/vscode/blob/main/3-1/Python%20Installation.png?raw=true) | ![img](https://github.com/Hwang-eojin/vscode/blob/main/3-1/Python%20Example%201.png?raw=true) |
       | :----------------------------------------------------------: | :----------------------------------------------------------: |
